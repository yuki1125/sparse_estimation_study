...
$$
(y-\hat{y})^2 -2(\beta_1-\hat{\beta}_1)x_1y -2(\beta_2-\hat{\beta}_2)x_2y+2(\beta_1-\hat{\beta}_1)x_1\hat{y}+2(\beta_2-\hat{\beta}_2)x_2\hat{y}\\+(\beta_1-\hat{\beta}_1)^2x_1^2+(\beta_2-\hat{\beta}_2)^2x_2^2+2(\beta_1-\hat{\beta}_1)(\beta_2-\hat{\beta}_2)x_1x_2
$$
